...
<body>
    <div id="cabecera">
        ...
        <a href="recuperar.php"><i class="fa-light fa-magnifying-glass"></i>Recuperar cuenta</a>
    </div>
    
    <form onsubmit="iniciar(); return false;">
        <div>
            <label>Correo</label>
    ...
    <script>
        ...
        function iniciar(){
            peticion.open("POST", "modelo/iniciar.php", true);
